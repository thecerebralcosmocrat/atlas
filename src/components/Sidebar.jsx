...
export default function Sidebar({
  ...
  return (
    <aside className="m-2 flex h-[calc(100vh-16px)] w-[260px] flex-shrink-0 flex-col rounded-[calc(10px-2px)] border border-sidebar-border bg-sidebar shadow-sm">
      {/* Sidebar header */}
          ...
          {repositories.map((repository) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "flex min-h-12 w-full cursor-pointer items-center overflow-hidden rounded-[calc(var(--radius)+0.375rem)] px-3 py-2 transition-[background-color,color,box-shadow] duration-150 ease-out active:bg-sidebar-accent/80",
                  active
